  ...
  public void process(Node node) {
    ...
    if (runtime.test("translate")) {
		...
		public void visitIntegerLiteral(GNode n){
			if(hflag == true){
				hstring.getFirst().concat(n.getString(0));
			}
			else{
				ccstring.getFirst().concat(n.getString(0));
			}
		...
		public void visitExpressionStatement(GNode n){
			...
			if (hflag == true){
				...
				hstring.getFirst().concat(";\r");
			}
			else{
				ccstring.getFirst().concat(";\r");
			}
			//System.out.print(";\r");
		}
		...
		public void ExpressionHandler(GNode n){
			for(Object o: n){
				if (o instanceof Node){
					...
					if(o != null){
						if (hflag == true){
							hstring.getFirst().concat((String)o).toString();
						}
						else{
							ccstring.getFirst().concat((String)o).toString();
						}
					}
...
//			}
		...
		public void visitModifier(GNode n){
			System.out.println(hstring.getFirst());
			if (hflag == true){ //this type belongs to the .h file
				hstring.addFirst(hstring.getFirst().concat(n.getString(0) + " "));
			}
			else{  //this type belongs to the .cc file
				ccstring.addFirst(ccstring.getFirst().concat(n.getString(0) + " "));
			}
			//System.out.print(n.getString(0) + " ");
		}
		...
		public void visitDeclarator(GNode n){
			if(hflag == true){
				hstring.getFirst().concat(n.getString(0)); //check for other children, if has children then =, else nothing
				System.out.println(n.hasVariable());
				if(n.hasVariable())
					hstring.getFirst().concat("=");
				visit(n);
				hstring.getFirst().concat("; \r");
				methodCC.add(ccstring.getFirst());
			}
			else{
				ccstring.getFirst().concat(n.getString(0) + "=");
				visit(n);
...
//					if(hflag == true){
//						System.out.println(hstring.getFirst());
//						includesCC.add(hstring.getFirst());
//						hstring.getFirst() = " ";
//						hstring.getFirst() = hstring.getFirst().replace(" ", "");
//					}
//					else{
//						System.out.println(ccstring.getFirst());
//						ccstring.getFirst() = " ";
//						ccstring.getFirst() = ccstring.getFirst().replace(" ", "");
//					}
				}
				else{
					//if(o != null)
		...
		public void visitImportDeclaration(GNode n){								//ToDo: Separate .cc and .h imports
			...
			ccstring.getFirst().concat(">;");
			includesCC.add(ccstring.getFirst());
			ccstring.clear();
		}
